...
from utils import feature_labels, feature_ranges, car2config, config2car, densities, wheelmoment, blacklist, chopshopfeatures2indexlist
...
base_config = car2config(session['final_design']) ### THIS IS THE CHANGE!!!!!
