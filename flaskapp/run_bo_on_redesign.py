'''
    This modified version of run_bo_on_redesign runs on the modified 
'''
...
new_session_dir = os.path.join(Config.FILE_PATH,user_id,"bo_sessions_start_from_redesign",str(session["_id"])) # session_id is an ObjectID, not str
