...
vid_path = 'train_logs_video_dump_10eps/vids'
# make the log directory before running
driver = DQNAgent(num_episodes=15, replay_freq=50, lr=0.001, train_dir = 'train_logs_video_dump_50rf',vid_path=vid_path)
...
def test_drive(config, video_path=None):
    ...
    return -driver.play_one(eps=0.1,train=False,video_path=video_path)[0]
