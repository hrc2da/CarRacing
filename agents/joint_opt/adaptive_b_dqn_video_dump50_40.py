...
vid_path = 'train_logs_video_dump_50rf_testing/vids'
# make the log directory before running
driver = DQNAgent(num_episodes=15, replay_freq=50, lr=0.001, train_dir = 'train_logs_video_dump_50rf_testing',vid_path=vid_path)
...
if __name__=="__main__":
    ...
    x0 = [config]
    y0 = np.array([result])
    rewards = policy_step(config2car(config),2)
