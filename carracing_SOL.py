...
"""TAKEN FROM OPEN AI GYM SOLUTIONS FOR TESTING PURPOSES ONLY"""
...
for ep in range(EPISODES):
	...
	for t in range(TIMESTAMP):
		...
		# print data_batch['X'].shape , data_batch['Y1'].shape , data_batch['C1'].shape
		reset = False

		if data_batch['X'].shape[0] == BATCH_SIZE:
			nnet.train(data_batch['X'] , data_batch['Y1'], data_batch['Y2'], data_batch['Y3'], data_batch['C1'],data_batch['C2'], data_batch['C3'])
			reset = True
...
save_path = nnet.saver.save(nnet.sess, "temp/model.ckpt")
