...
def create_nn(model_to_load, stack_len, config_size, freeze_hidden=False, lr = 0.01):
    try:
        ...
        model = Sequential()
        model.add(Dense(512, input_shape=(stack_len*111+config_size,), kernel_initializer="lecun_uniform"))# 7x7 + 3.  or 14x14 + 3 # a
