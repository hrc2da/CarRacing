...
users = [
    ...
    '0a72d691a07b4da9a6bf1566fcb3792a', # anna fixed
    ...
    '1b7db0cc7094434b85c284547269f99c' #george 11 friend 2 -- feature confidence z 1 needs to run retrain on human
...
sessions = [
    ...
    '6010756cfc02e9ccd6a34a25', #anna-fixed
...
session2indexdict = {k:i for i,k in enumerate(sessions)}